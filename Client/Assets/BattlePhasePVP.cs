...
public class BattlePhasePVP : MonoBehaviour {
	...
	void Start () {
        ...
        attackResult.Add("nextCritical", "0");
        ...
        //當enemy選好動作時觸發
    {
        ...
        enemyCritActivated = int.Parse(data["nextCritical"].ToString().Replace("\"", ""));
